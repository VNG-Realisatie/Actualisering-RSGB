...
- Te komen tot één consistente versie van het RSGB, met als uitgangspunt de laatst vastgestelde versie van het RSGB 2.x en het LO-BRP (laatste versie) ;
- één consistente versie van het RGBZ;
- Het RSGB in lijn te brengen met StUF-BG;
- Het RGBZ 2.x en ImZTC afstemmen met de ZGW API’s ;
- Het publiceren van de informatiemodellen op GitHub, op basis van bestaande tooling en afspraken.
...
- Verschillen-analyse RSGB - Gegevenscatalogus Handelsregister
- Verschillen-analyse RSGB - IMBAG
